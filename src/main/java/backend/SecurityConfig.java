...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
	        ...
	        .authorizeRequests()
				...
				.antMatchers("/index", "/noConformidades", "/ta/tramitesAudiencia", "/ap/apelaciones", "/reclamaciones",
								"/addNoConformidad", "/addAccion", "deleteAccion", "/manageNoConformidad", "/deleteNoConformidad",
								"/uploadDocumentoExtension", "/updateNoConformidad", "/addEvidencia",
								"/deleteDocumentoExtension", "/updateAccion", "/updateEvidencia", "/deleteEvidencia",
								"/getEvidenciasAccion", "/searchNoConformidad", "/sortCurrentNoConformidadList",
								"/ta/**", "/ap/**", "/rc/**").hasAnyRole("ADMIN", "USER")
				.antMatchers("/admin/**", "/usuarios", "/modifyUser", "/getUser", "/deleteUser", "/createUser").hasRole("ADMIN")	   // <-- administration
	 ...
	 */
	@Bean
	public AcertaUserDetailsService springDataUserDetailsService() {
		return new AcertaUserDetailsService();
	} 

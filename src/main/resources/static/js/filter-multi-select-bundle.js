(function ($) {
    ...
    function () {
      ...
      FilterMultiSelect.prototype.initialize = function () {
        ...
        this.placeholder.className = 'customPlaceholder';
      ...
      function () {
        ...
        class_2.prototype.initialize = function () {
          ...
          this.checkbox.addEventListener('change', function (e) {
            ...
            /* console.log("--- inside checkbox change listener ---");
            console.log("value: " + _this.checkbox.value); */
            manageCausasMultipleSelect()
            checkUpdateNC(event)
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
      ...
      if (typeof args.placeholderText === 'undefined') args.placeholderText = ' Seleccionar...';
